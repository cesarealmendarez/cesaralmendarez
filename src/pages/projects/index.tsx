...
export default function Projects() {
    return (
        <div className="w-full flex flex-col items-start justify-start space-y-6 mt-6">
            ...
            <ul className="w-full border-t border-neutral-800">
                {projects.map((project, idx) => {
                    return (
                        <li className="w-full flex flex-col items-start justify-start border-b border-neutral-800 py-4 px-0 space-y-2">
